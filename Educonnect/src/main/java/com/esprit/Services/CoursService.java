...
public class CoursService {
    ...
    public void addCours(Cours cours) throws IOException, SQLException {
        // First verify the category exists
        CategorieService categorieService = new CategorieService();
        Categorie dbCategorie = categorieService.getCategorieById(cours.getCategorie().getId());

        if (dbCategorie == null) {
            throw new SQLException("Category with ID " + cours.getCategorie().getId() + " does not exist");
        }

        // Use the category from database to ensure consistency
        cours.setCategorie(dbCategorie);
    ...
    public void updateCours(Cours cours) throws IOException, SQLException {
