...
public class EventController {
    ...
    public void initialize() {
        ...
        System.out.println("Table initialized. Columns: " + eventTable.getColumns().size());
    }
    ...
    private void initializeTableColumns() {
        ...
        // Date column - show just the date part
        dateColumn.setCellValueFactory(cellData ->
                new SimpleObjectProperty<>(cellData.getValue().getStartDatetime()));
        ...
        // Time column - show just the time part
    ...
    public void refreshEventTable() {
        try {
            ...
            if ((searchTerm == null || searchTerm.isEmpty()) && selectedCategory == null) {
                ...
                eventsList = eventService.searchAndFilterEvents(searchTerm, selectedCategory);
            }
            ...
            // Debug: Check table state after refresh
            System.out.println("Table items: " + eventTable.getItems().size());
            System.out.println("Table columns: " + eventTable.getColumns().size());
