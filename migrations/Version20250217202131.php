 ...
 */
final class Version20250217202131 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test DROP idtest');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test ADD idtest INT NOT NULL');
    }
}
