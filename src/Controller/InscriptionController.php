...
class InscriptionController extends AbstractController
{
    ...
    public function inscrire(
        ...
        $phoneNumber = $user->getNumTlfn(); // Suppose que l'utilisateur a un champ téléphone
        $message = "Bonjour {$user->getNom()}, vous êtes inscrit(e) au cours : {$cours->getTitre()}.";
    
        // if ($phoneNumber) {
        //     $whatsAppService->sendMessage('+216'.$phoneNumber, $message);
        // }
