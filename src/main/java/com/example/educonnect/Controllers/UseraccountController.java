package com.example.educonnect.Controllers;

import com.example.educonnect.Entities.*;
import com.example.educonnect.Main;
import com.example.educonnect.Repository.*;
import com.example.educonnect.Utils.Modals;
...
import static com.example.educonnect.Utils.Validator.isValidEmail;
    ...
    public void onLogoutButtonClick(ActionEvent actionEvent) {
        try {
            ...
            if (option.get().equals(ButtonType.OK)) {
                ...
                Parent root = FXMLLoader.load(com.example.educonnect.Main.class.getResource("views/mainLoginSignUp.fxml"));
